...
const products = {
  abrazaderas: [
    ...
    {
      id: 6,
      name: "Abrazadera de reparacion de codos - Elbow - SEALPRO CE",
  ...
  kits: [
    {
      id: 5,
      name: "Kit Reparación Fugas con presión - SealPRO E",
      description: "Kit completo para reparación de fugas en tuberías",
      image: "/pipe-leak-repair-kit-professional-tools.jpg",
      specs: ["Incluye: 15 componentes", "Efectividad: 99%", "Garantía: 5 años"],
      applications: ["Fugas activas", "Mantenimiento preventivo", "Emergencias industriales"],
    },
    {
      id: 6,
      name: "Kit Sellado Temporal",
      description: "Solución rápida para sellado temporal de fugas",
      image: "/temporary-pipe-sealing-kit-industrial.jpg",
      specs: ["Tiempo aplicación: 2 minutos", "Resistencia: 100 PSI", "Duración: 6 meses"],
